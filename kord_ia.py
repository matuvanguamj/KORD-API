...
RETOURNE UNIQUEMENT LE JSON SUIVANT (rien d'autre, pas de markdown) :
{
  "resume_executif": {
    "paragraphe_1": "Situation globale. Score X/100 signifie quoi concrètement. Les 2-3 constats les plus importants avec chiffres.",
    "paragraphe_2": "Points forts identifiés dans les données. Ce qui fonctionne bien avec preuves chiffrées.",
    "paragraphe_3": "Signaux d'alerte principaux. Ce qui coûte de l'argent maintenant. Estimation du potentiel de gain global."
  },
  "message_dirigeant": "Message personnel au dirigeant. Ton conseil le plus important. Ce que tu ferais en priorité si tu étais à sa place. 3-4 phrases directes.",
  "analyse_piliers": {
    "stock_cash": {
      "titre": "Stock et Cash Immobilisé",
      "score": 0,
      "max": 30,
      "niveau": "bon/moyen/critique",
      "analyse": "Paragraphe de 5-8 lignes. Ce que les données révèlent concrètement. Chiffres précis. Risques identifiés. Comparaison benchmark.",
      "chiffres_cles": ["Chiffre 1 avec contexte", "Chiffre 2 avec contexte"],
      "risque_principal": "Description du risque principal avec impact €"
    },
    "transport_service": { "titre": "Transport et Taux de Service", "score": 0, "max": 20, "niveau": "...", "analyse": "...", "chiffres_cles": [], "risque_principal": "..." },
    "achats_fournisseurs": { "titre": "Achats et Fournisseurs", "score": 0, "max": 20, "niveau": "...", "analyse": "...", "chiffres_cles": [], "risque_principal": "..." },
    "marges_retours": { "titre": "Marges et Retours Clients", "score": 0, "max": 15, "niveau": "...", "analyse": "...", "chiffres_cles": [], "risque_principal": "..." },
    "donnees_pilotage": { "titre": "Données et Pilotage", "score": 0, "max": 15, "niveau": "...", "analyse": "...", "chiffres_cles": [], "risque_principal": "..." }
  },
  "croisements_cles": [
    {
      "fichiers": ["fichier1.csv", "fichier2.csv"],
      "observation": "Ce que révèle le croisement des deux fichiers ensemble",
      "impact": "Impact business de cette corrélation en €"
    }
  ],
  "anomalies": [
    {
      ...
      "pilier": "nom_pilier",
      "detection": "Ce qui a été détecté avec les chiffres précis",
      "impact_business": "Pourquoi c'est problématique — impact sur le CA, la marge ou la trésorerie",
      "impact_financier": "Estimation en € ou %",
      "urgence": "CRITIQUE / MOYEN / FAIBLE",
      "exemple": "Exemple concret pour illustrer"
    }
  ],
  "priorites": [
    {
      ...
      "pilier": "nom_pilier",
      "probleme": "Description précise du problème avec chiffres",
      "action": "Action concrète — qui fait quoi exactement",
      "impact_attendu": "Ex: réduire le cash immobilisé de ~15%, soit environ X€",
      "gain_potentiel": "Fourchette en € réaliste",
      "delai": "Sous 30 jours / Sous 60 jours / Sous 90 jours",
      "complexite": "Facile / Modéré / Complexe",
      "quick_win": true
    }
  ],
  "questions_restitution": [
    "Question 1 à poser au client en session de restitution",
    "Question 2 à poser au client",
    "Question 3 à poser au client"
  ],
  "prochaine_etape": "Message personnalisé vers la session de restitution. Contexte spécifique au client. Ce qu'on va travailler ensemble.",
  "benchmark": "Comparaison sectorielle. Score X vs moyenne secteur. Ce que les entreprises comparables font différemment.",
  "points_vigilance": ["Point 1 avec chiffre et contexte", "Point 2", "Point 3"],
  "opportunites_cachees": [
    {
      "titre": "Titre de l'opportunité",
      "description": "Description détaillée basée sur les données",
      "gain_estime": "X€ à Y€ selon les hypothèses"
    }
  ]
}"""
