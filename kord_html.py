...
<div class="cover">
  ...
  <div class="cover-right">
    ...
    <div class="cover-piliers">
      {''.join(f"""<div class="cover-pilier-row">
        <span class="cover-pilier-name">{pilier_meta[k][0].split(" et ")[0]}</span>
        <div class="cover-pilier-bar-wrap"><div class="cover-pilier-bar" style="width:{round(consolidated.get('analyses',{{}}).get(k,{{}}).get('score',0)/pilier_meta[k][1]*100) if pilier_meta[k][1]>0 else 0}%"></div></div>
        <span class="cover-pilier-score">{consolidated.get('analyses',{{}}).get(k,{{}}).get('score',0)}/{pilier_meta[k][1]}</span>
      </div>""" for k in pilier_order)}
    </div>
  </div>
</div>
